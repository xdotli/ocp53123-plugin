...
useMemo }) => {
    ...
    const renderToggle = (randomId) => (react_1.default.createElement(ToggleComponent, Object.assign({ className: react_styles_1.css(tree_view_1.default.treeViewNodeToggle), onClick: (evt) => {
    ...
    const renderNodeContent = () => {
        const content = (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            isSelectable ? (react_1.default.createElement("button", { tabIndex: -1, className: react_styles_1.css(tree_view_1.default.treeViewNodeText) }, name)) : (react_1.default.createElement("span", { className: react_styles_1.css(tree_view_1.default.treeViewNodeText) }, name))));
        return isCompact ? react_1.default.createElement("span", { className: react_styles_1.css(tree_view_1.default.treeViewNodeContent) }, content) : content;
    };
    ...
    return (react_1.default.createElement("li", Object.assign({ id: id, className: react_styles_1.css(tree_view_1.default.treeViewListItem, internalIsExpanded && tree_view_1.default.modifiers.expanded) }, (internalIsExpanded && { 'aria-expanded': 'true' }), { role: "treeitem", tabIndex: -1 }),
        react_1.default.createElement("div", { className: react_styles_1.css(tree_view_1.default.treeViewContent) },
            react_1.default.createElement(GenerateId_1.GenerateId, { prefix: isSelectable ? 'selectable-id' : 'checkbox-id' }, randomId => (react_1.default.createElement(Component, Object.assign({ className: react_styles_1.css(tree_view_1.default.treeViewNode, children && (isSelectable || hasCheck) && tree_view_1.default.modifiers.selectable, (!children || isSelectable) &&
                ...
                react_1.default.createElement("span", { className: react_styles_1.css(tree_view_1.default.treeViewNodeContainer) },
