...
class ApplicationLauncher extends React.Component {
    ...
    render() {
        ...
        favoritesLabel, searchNoResultsText, menuAppendTo, removeFindDomNode } = _a, props = tslib_1.__rest(_a, ['aria-label', "isOpen", "onToggle", "toggleIcon", "toggleId", "onSelect", "isDisabled", "className", "isGrouped", "favorites", "onFavorite", "onSearch", "items", "searchPlaceholderText", "searchProps", "ref", "favoritesLabel", "searchNoResultsText", "menuAppendTo", "removeFindDomNode"]);
        let renderableItems = [];
        if (onFavorite) {
            let favoritesGroup = [];
