...
class Tabs extends React.Component {
    constructor(props) {
        ...
        this.countOverflowingElements = (container) => {
            ...
            return elements.filter(element => !util_1.isElementInView(container, element, false)).length;
        };
    ...
    render() {
        ...
        return (React.createElement(TabsContext_1.TabsContextProvider, { value: {
            ...
            React.createElement(Component, Object.assign({ "aria-label": ariaLabel, className: react_styles_1.css(tabs_1.default.tabs, isFilled && tabs_1.default.modifiers.fill, isSecondary && tabs_1.default.modifiers.secondary, isVertical && tabs_1.default.modifiers.vertical, isVertical && expandable && util_1.formatBreakpointMods(expandable, tabs_1.default), isVertical && expandable && isExpandedLocal && tabs_1.default.modifiers.expanded, isBox && tabs_1.default.modifiers.box, showScrollButtons && tabs_1.default.modifiers.scrollable, usePageInsets && tabs_1.default.modifiers.pageInsets, !hasBorderBottom && tabs_1.default.modifiers.noBorderBottom, hasSecondaryBorderBottom && tabs_1.default.modifiers.borderBottom, util_1.formatBreakpointMods(inset, tabs_1.default), variantStyle[variant], hasOverflowTab && tabs_1.default.modifiers.overflow, className) }, helpers_1.getOUIAProps(Tabs.displayName, ouiaId !== undefined ? ouiaId : this.state.ouiaStateId, ouiaSafe), { id: id && id }, props),
                ...
                renderScrollButtons && (React.createElement("button", { type: "button", className: react_styles_1.css(tabs_1.default.tabsScrollButton, isSecondary && button_1.default.modifiers.secondary), "aria-label": leftScrollAriaLabel, onClick: this.scrollLeft, disabled: disableLeftScrollButton, "aria-hidden": disableLeftScrollButton, ref: this.leftScrollButtonRef },
                    React.createElement(angle_left_icon_1.default, null))),
                React.createElement("ul", { className: react_styles_1.css(tabs_1.default.tabsList), ref: this.tabList, onScroll: this.handleScrollButtons, role: "tablist" },
                ...
                renderScrollButtons && (React.createElement("button", { type: "button", className: react_styles_1.css(tabs_1.default.tabsScrollButton, isSecondary && button_1.default.modifiers.secondary), "aria-label": rightScrollAriaLabel, onClick: this.scrollRight, disabled: disableRightScrollButton, "aria-hidden": disableRightScrollButton },
