...
const DropdownGroup = (_a) => {
    ...
    return (react_1.default.createElement(Menu_1.MenuGroup, Object.assign({ className: react_styles_1.css(className), label: label, labelHeadingLevel: labelHeadingLevel }, props), children));
};
