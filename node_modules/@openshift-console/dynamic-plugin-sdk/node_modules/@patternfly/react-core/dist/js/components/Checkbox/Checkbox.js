...
class Checkbox extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Component, { className: react_styles_1.css(check_1.default.check, !label && check_1.default.modifiers.standalone, className) },
            React.createElement("input", Object.assign({}, props, { className: react_styles_1.css(check_1.default.checkInput), type: "checkbox", onChange: this.handleChange, "aria-invalid": !isValid, "aria-label": ariaLabel, disabled: isDisabled, required: isRequired, ref: elem => elem && (elem.indeterminate = isChecked === null) }, checkedProps, helpers_1.getOUIAProps(Checkbox.displayName, ouiaId !== undefined ? ouiaId : this.state.ouiaStateId, ouiaSafe))),
            label && (React.createElement("label", { className: react_styles_1.css(check_1.default.checkLabel, isDisabled && check_1.default.modifiers.disabled), htmlFor: props.id },
                label,
                isRequired && (React.createElement("span", { className: react_styles_1.css(check_1.default.checkLabelRequired), "aria-hidden": "true" }, htmlConstants_1.ASTERISK)))),
