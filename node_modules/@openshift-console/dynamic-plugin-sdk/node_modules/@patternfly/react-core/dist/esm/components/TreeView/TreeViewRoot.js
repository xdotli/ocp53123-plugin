...
export class TreeViewRoot extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.hasChecks) {
            const firstToggle = (_a = this.treeRef.current) === null || _a === void 0 ? void 0 : _a.getElementsByClassName('pf-c-tree-view__node-toggle')[0];
            if (firstToggle) {
                firstToggle.tabIndex = 0;
            }
            const firstInput = (_b = this.treeRef.current) === null || _b === void 0 ? void 0 : _b.getElementsByTagName('INPUT')[0];
            if (firstInput) {
                firstInput.tabIndex = 0;
            }
        }
        else {
            ((_c = this.treeRef.current) === null || _c === void 0 ? void 0 : _c.getElementsByClassName('pf-c-tree-view__node')[0]).tabIndex = 0;
        }
    }
