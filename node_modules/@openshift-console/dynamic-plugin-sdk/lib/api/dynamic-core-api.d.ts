...
import { ErrorBoundaryFallbackProps, HorizontalNavProps, UseResolvedExtensions, VirtualizedTableFC, TableDataProps, UseActiveColumns, ListPageHeaderProps, ListPageCreateProps, ListPageCreateLinkProps, ListPageCreateButtonProps, ListPageCreateDropdownProps, ListPageFilterProps, UseListPageFilter, ResourceLinkProps, ResourceIconProps, OverviewProps, OverviewGridProps, InventoryItemTitleProps, InventoryItemBodyProps, InventoryItemStatusProps, YAMLEditorProps, ResourceYAMLEditorProps, ResourceEventStreamProps, UsePrometheusPoll, TimestampProps, NamespaceBarProps, YAMLEditorRef } from '../extensions/console-types';
 ...
 */
export declare const YAMLEditor: React.ForwardRefExoticComponent<YAMLEditorProps & React.RefAttributes<YAMLEditorRef>>;
/**
