...
export declare type ClusterConfigurationFieldProps = {
    readonly: boolean;
};
...
export declare type ClusterConfigurationTextField = {
...
export declare type ClusterConfigurationCheckboxFieldValue = string | number | boolean;
export declare type ClusterConfigurationCheckboxField = {
...
export declare type ClusterConfigurationDropdownFieldValue = string;
export declare type ClusterConfigurationDropdownField = {
...
export declare type ClusterConfigurationCustomField = {
...
export declare type ClusterConfigurationField = ClusterConfigurationCustomField;
export declare type ClusterConfigurationGroup = ExtensionDeclaration<'console.cluster-configuration/group', {
...
export declare type ClusterConfigurationItem = ExtensionDeclaration<'console.cluster-configuration/item', {
