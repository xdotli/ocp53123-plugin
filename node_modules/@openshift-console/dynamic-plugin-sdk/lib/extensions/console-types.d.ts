...
import { ExtensionK8sGroupKindModel, K8sModel, PrometheusEndpoint, PrometheusLabels, PrometheusValue, ResolvedExtension, Selector } from '../api/common-types';
...
export declare type YAMLEditorProps = {
    value?: string;
    options?: object;
...
export declare type YAMLEditorRef = {
