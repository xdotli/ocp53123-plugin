...
export declare type GroupedMenuOption = ActionGroup['properties'] & {
    children?: MenuOption[];
};
export declare type MenuOption = Action | GroupedMenuOption;
export declare type ActionService = {
    actions: Action[];
    options: MenuOption[];
    loaded: boolean;
    error: any;
...
export declare type ActionServiceProviderProps = {
