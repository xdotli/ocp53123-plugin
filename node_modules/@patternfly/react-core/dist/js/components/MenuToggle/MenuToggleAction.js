...
class MenuToggleAction extends React.Component {
    render() {
        ...
        return (React.createElement("button", Object.assign({ id: id, className: react_styles_1.css(menu_toggle_1.default.menuToggleButton, className), onClick: onClick, type: "button", disabled: isDisabled }, props), children));
    }
}
