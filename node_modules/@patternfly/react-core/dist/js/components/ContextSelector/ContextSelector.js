...
class ContextSelector extends React.Component {
    ...
    render() {
        ...
        const menuContainer = (React.createElement("div", Object.assign({ className: react_styles_1.css(context_selector_1.default.contextSelectorMenu) }, (isFlipEnabled && { style: { position: 'revert' } }), { id: uniqueId }), isOpen && (React.createElement(helpers_1.FocusTrap, { active: !disableFocusTrap, focusTrapOptions: { clickOutsideDeactivates: true, tabbableOptions: { displayCheck: 'none' } } },
