...
const OverflowTab = (_a) => {
    var { className, overflowingTabs = [], showTabCount, defaultTitleText = 'More', toggleAriaLabel } = _a, props = tslib_1.__rest(_a, ["className", "overflowingTabs", "showTabCount", "defaultTitleText", "toggleAriaLabel"]);
    ...
    const overflowTab = (react_1.default.createElement("li", Object.assign({ className: react_styles_1.css(tabs_1.default.tabsItem, 'pf-m-overflow', selectedTab && tabs_1.default.modifiers.current, className), role: "presentation", ref: overflowLIRef }, props),
        react_1.default.createElement("button", { className: react_styles_1.css(tabs_1.default.tabsLink, isExpanded && tabs_1.default.modifiers.expanded), onClick: () => toggleMenu(), "aria-label": toggleAriaLabel, "aria-haspopup": "menu", "aria-expanded": isExpanded, role: "tab", ref: overflowTabRef },
    ...
    return (react_1.default.createElement(helpers_1.Popper, { trigger: overflowTab, popper: overflowMenu, isVisible: isExpanded, popperMatchesTriggerWidth: false, appendTo: overflowLIRef.current }));
};
