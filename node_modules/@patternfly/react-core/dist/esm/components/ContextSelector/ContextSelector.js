...
export class ContextSelector extends React.Component {
    ...
    render() {
        ...
        const menuContainer = (React.createElement("div", Object.assign({ className: css(styles.contextSelectorMenu) }, (isFlipEnabled && { style: { position: 'revert' } }), { id: uniqueId }), isOpen && (React.createElement(FocusTrap, { active: !disableFocusTrap, focusTrapOptions: { clickOutsideDeactivates: true, tabbableOptions: { displayCheck: 'none' } } },
