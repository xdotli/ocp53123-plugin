...
export class Page extends React.Component {
    ...
    render() {
        ...
        const group = isGrouped ? (React.createElement("div", Object.assign({ className: css(styles.pageMainGroup, formatBreakpointMods(groupProps === null || groupProps === void 0 ? void 0 : groupProps.stickyOnBreakpoint, styles, 'sticky-', getVerticalBreakpoint(height), true)) }, groupProps),
